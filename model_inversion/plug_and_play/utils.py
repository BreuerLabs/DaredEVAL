...
#! TODO: Modify
def create_candidates(generator, target_model, targets):
...
#! TODO: Modify
def create_initial_vectors(G, target_model, targets, device):
    with torch.no_grad():
        w = create_candidates(G, target_model, targets).cpu() #? move to device instead of cpu?
